...
export default function Footer({ translations, locale }) {
        ...
        <footer className="bg-gray-800 text-white">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        <h3 className="text-sm font-semibold uppercase tracking-wider">{translations.legal}</h3>
                        <ul className="mt-4 space-y-2">
                            <li>
                                <Link
                                    href={`/${locale}/privacy`}
                    ...
                    <div>
                        <h3 className="text-sm font-semibold uppercase tracking-wider">{translations.contactUs}</h3>
                        <ul className="mt-4 space-y-2">
